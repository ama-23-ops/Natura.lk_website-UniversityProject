...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_review'])) {
        if (!$canReview) {
            $_SESSION['error'] = "You must purchase and receive this product before leaving a review.";
        } elseif ($hasReviewed) {
...
<body>
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6 product-card mt-20">
            <div class="md:flex">
                <!-- Product Image -->
                ...
                <div class="md:w-1/2">
                    ...
                    <form method="post" action="/customer/cart.php" class="mb-4">
            ...
            <?php elseif (!$canReview): ?>
                <div class="bg-blue-50 p-4 rounded-lg mb-6">
                    <p class="text-blue-800">
                        ...
                        Purchase and receive this product to unlock the ability to write a review! Your experience will help other customers make informed decisions.
                    </p>
                </div>
            <?php endif; ?>
