...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="mb-8 w-full bg-white rounded-lg shadow-md p-6">
        ...
        <?php else: ?>
            ...
            <?php if ($total_pages > 1): ?>
                <div class="flex justify-center mt-8 gap-2">
                    <?php if ($page > 1): ?>
                        <a href="?page=<?= $page-1 ?>&min_price=<?= urlencode($min_price) ?>&max_price=<?= urlencode($max_price) ?>&category=<?= urlencode($category_filter) ?>" 
                    ...
                    <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                        <a href="?page=<?= $i ?>&min_price=<?= urlencode($min_price) ?>&max_price=<?= urlencode($max_price) ?>&category=<?= urlencode($category_filter) ?>" 
                           class="<?= $i === $page ? 'bg-teal-700' : 'bg-teal-600' ?> text-white px-4 py-2 rounded-lg hover:bg-teal-700 transition">
                            <?= $i ?>
                        </a>
                    <?php endfor; ?>
